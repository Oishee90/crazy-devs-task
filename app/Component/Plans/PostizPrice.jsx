...
const PostizPrice = () => {
    return (
        ...
        {/* card */}
        {/* 1 start */}
<div className="md:w-[566px] w-[287px]   px-7 py-4 bg-[#242323] border border-[#353434] rounded-xl shadow-md text-white md:mt-7 mt-3 dark:bg-gray-800">
...
<div className="md:w-[566px] w-[287px]   px-7 py-4 bg-[#242323] border border-[#353434] rounded-xl shadow-md text-white md:mt-7 mt-3 dark:bg-gray-800">
  <div className="flex md:flex-row flex-col gap-3 justify-between p-4 ">
    ...
    <h1 className='md:mt-2 text-lg md:text-xl dm-sans text-white'>Users: unlimited</h1> 
        ...
        {/* 3 start */}
<div className="md:w-[566px] w-[287px]   px-7 py-4 bg-[#242323] borde border-[#353434] rounded-xl shadow-md text-white md:mt-7 mt-3 dark:bg-gray-800">
  <div className="flex md:flex-row flex-col gap-3 justify-between p-4 ">
    <div> 
...
<h1 className='text-[22px] plus-jakarta font-bold'>On-premise services & Enterprise</h1>
       ...
       <div className="md:w-[566px] w-[287px]   px-7 py-4 bg-gradient-to-b from-[#45007C] to-[#1C0033] border border-[#45007C] rounded-xl shadow-md text-white  mt-5 dark:bg-gray-800">
 <div className="flex md:flex-row flex-col gap-3 justify-between p-4 ">
   <div> 
   ...
   <h1 className='md:mt-2 text-lg md:text-xl dm-sans text-white'>Users: 1</h1> 
       ...
       <div className="md:w-[566px] w-[287px]   px-7 py-4 bg-gradient-to-b from-[#6B007C] to-[#280033] border border-[#6B007C] rounded-xl shadow-md text-white  mt-5 dark:bg-gray-800">
 <div className="flex md:flex-row flex-col gap-3 justify-between p-4 ">
   <div> 
